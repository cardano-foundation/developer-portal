...
alt="Milkomeda"
sources={{
    light: useBaseUrl('/img/blog/devblog/milkomeda-light.png'),
    dark: useBaseUrl('/img/blog/devblog/milkomeda-dark.png'),
  }}
...
Some of the projects that have already been integrated are [Blueshift](https://blueshift.com), OccamX, [Nomad](https://www.nomad.xyz), [Muesliswap](https://muesliswap.com), and [BridgeC (Celer)](https://cbridge.celer.network/#/transfer).
