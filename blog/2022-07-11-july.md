...
image: https://developers.cardano.org/img/og/blog/koios.png
---
...
alt="Koios"
sources={{
    light: useBaseUrl('/img/blog/devblog/koios-light.png'),
    dark: useBaseUrl('/img/blog/devblog/koios-dark.png'),
  }}
