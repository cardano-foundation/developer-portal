...
image: https://developers.cardano.org/img/og/blog/gimbalabs.png
---
...
alt="GMBL"
sources={{
    light: useBaseUrl('/img/blog/devblog/gmbl-dark.png'),
    dark: useBaseUrl('/img/blog/devblog/gmbl-light.png'),
  }}
/>](https://gimbalabs.com/)
