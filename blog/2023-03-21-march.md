...
image: https://developers.cardano.org/img/og/blog/mesh.png
---
...
alt="Mesh"
sources={{
    light: useBaseUrl('/img/blog/devblog/mesh-dark.png'),
    dark: useBaseUrl('/img/blog/devblog/mesh-light.png'),
  }}
/>](https://meshjs.dev/)
...
You can stay updated on the latest Mesh development by following [@meshsdk](https://twitter.com/meshsdk) on Twitter. If you want to start building on Cardano, check out our [guides](https://meshjs.dev/guides), our guides in the [developer portal](https://meshjs.dev/), and [start building](https://meshjs.dev/apis). 
