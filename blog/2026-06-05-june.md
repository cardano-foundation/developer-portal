...
import useBaseUrl from '@docusaurus/useBaseUrl';
 ...
 [<ThemedImage
style={{width: '300px'}}
alt="https://vola.network"
sources={{
    light: useBaseUrl('/img/blog/devblog/nuvola-dark.png'),
    dark: useBaseUrl('/img/blog/devblog/nuvola-light.png'),
  }}
/>](https://vola.network)
