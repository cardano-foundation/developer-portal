...
image: https://developers.cardano.org/img/og/blog/rejuve.png
---
...
sources={{
    light: useBaseUrl('/img/blog/devblog/rejuve-light.svg'),
    dark: useBaseUrl('/img/blog/devblog/rejuve-dark.svg'),
  }}
/>](https://www.rejuve.ai)
...
- [AVEA](https://avea-life.com/): science based longevity supplments
...
- [Peptide Bioregulator](https://peptide-bioregulator.com/): A niche class of supplements for serious biohackers, compounds which support and optimize the body's biological functions and processes.
...
- [TruDiagnostic](https://trudiagnostic.com/): Leveraging a robust DNA Methylation dataset to create more precise chronological and biological age algorithms (along with offering advanced biological age tests)
