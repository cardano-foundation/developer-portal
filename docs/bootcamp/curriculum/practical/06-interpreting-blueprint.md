...
slug: 06-interpreting-blueprint
---
...
> Source code: [GitHub](https://github.com/cardano-foundation/developer-portal/tree/staging/bootcamp-codes/06-interpreting-blueprint)
...
![VSCode command palette](./img/vscode-command.png)

4. Select the `plutus.json` file that contains the blueprint.
![VSCode command palette](./img/select-blueprint.png)
...
The source code for this lesson is available on [GitHub](https://github.com/cardano-foundation/developer-portal/tree/staging/bootcamp-codes/06-interpreting-blueprint).
