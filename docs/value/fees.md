...
This is the canonical reference for collateral; the [transaction lifecycle](/docs/value/transactions#deterministic-outcomes) and [Smart Contracts](/docs/build/smart-contracts/overview) link here.
...
- [Transactions](/docs/value/transactions): how fees fit into building and submitting
- [What are native tokens](/docs/native-tokens/overview): why token outputs cost more (min-ADA)
