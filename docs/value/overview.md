...
1. **[The eUTXO Model](/docs/value/eutxo)**: how Cardano represents and spends value
2. **[Addresses](/docs/value/addresses)**: where value lives and the credentials that guard it
3. **[Keys & Wallets](/docs/value/wallets-and-keys)**: who controls value, and how wallets manage keys
4. **[Transactions](/docs/value/transactions)**: how value moves
5. **[Transaction Fees](/docs/value/fees)**: what transactions cost and why
