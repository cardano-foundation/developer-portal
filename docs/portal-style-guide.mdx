...
URLs and URLs in angle brackets will automatically get turned into links. [http://www.cardano.org](http://www.cardano.org) or [http://www.cardano.org](http://www.cardano.org).
Some text to show that the reference links can follow later.
