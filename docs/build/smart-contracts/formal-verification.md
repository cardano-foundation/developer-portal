...
[Testing](/docs/build/smart-contracts/testing) shows a validator works on the cases you tried; **formal verification** proves it holds for all of them. For high-value contracts, machine-checked proofs of correctness are the strongest guarantee you can give.
