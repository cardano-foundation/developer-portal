...
1. Design your contract using [Marlowe Playground](https://playground.marlowe-lang.org/).
2. Press the `Send to Simulator` button and then press `Download as JSON` to download your contract in JSON format.
3. *If you want to run your contract at the command line using `marlowe-cli`,* install [`marlowe-cli`](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe-cli/ReadMe.md#installation) and follow the instructions [Running Contracts with Marlowe CLI](https://github.com/marlowe-lang/real-world-marlowe/blob/main/archives/marlowe-cli/lectures/04-marlowe-cli-concrete.md). A video lecture playlist [Marlowe CLI](https://www.youtube.com/playlist?list=PLNEK_Ejlx3x0GbvCw-61e9VfRafBT1JSw) provides an overview of the `marlowe-cli` tool.
4. *If you want to run your contract in a Jupyter notebook,* then use git to clone [github.com/marlowe-lang/marlowe-cardano](https://github.com/marlowe-lang/marlowe-cardano), run `nix develop --command jupyter-lab` from the `marlowe-cli/` folder, open the notebook [Marlowe CLI Lecture 4](https://github.com/marlowe-lang/marlowe-cardano/blob/mpp-cli-lectures/marlowe-cli/lectures/04-marlowe-cli-concrete.ipynb), and follow the instructions. A video lecture [Running a Marlowe Contract with Marlowe CLI](https://www.youtube.com/watch?v=DmF7dIKmJMo&list=PLNEK_Ejlx3x0GbvCw-61e9VfRafBT1JSw&index=4) demonstrates running a contract from within a Jupyter notebook.
5. *If you want to run your contract from the command-line using the Marlowe Runtime backend,* then follow the [tutorial for Marlowe Runtime](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe-runtime/doc/tutorial.ipynb). A video [Marlowe Runtime Tutorial](https://www.youtube.com/playlist?list=PLnPTB0CuBOByd1Y6W9B8Xj_wiiWkobtrY) demonstrates its use.
6. *If you want to run your contract using Marlowe Lambda,* follow the example for [using Marlowe Lambda from the command line](https://github.com/marlowe-lang/marlowe-lambda/blob/main/examples/zcb.ipynb) or study the example [web application for Marlowe Lambda](https://github.com/marlowe-lang/marlowe-lambda/tree/main/web). The video [Marlowe Lambda in the Browser](https://www.youtube.com/watch?v=yKhQpIEliBc&t=6s) demonstrate the use of Marlowe Lambda.
...
- [Marlowe language and semantics](https://github.com/marlowe-lang)
- [Marlowe Improvement Proposals (MIPs)](https://github.com/marlowe-lang/MIPs)
- [Marlowe on Cardano](https://github.com/marlowe-lang/marlowe-cardano)
- [Marlowe Playground](https://playground.marlowe-lang.org/)
- [PureScript implementation of Marlowe](https://github.com/marlowe-lang/purescript-marlowe)
- [ACTUS in Marlowe](https://github.com/marlowe-lang/marlowe-actus-labs)
- [AWS Lambda service for Marlowe Runtime](https://github.com/marlowe-lang/marlowe-lambda)
...
- [Discussion of improvements to Marlowe](https://github.com/marlowe-lang/MIPs/discussions)
- [Discussion of changes to Marlowe's implementation on Cardano](https://github.com/marlowe-lang/marlowe-cardano)

### Specifications

- [Marlowe Specification, Version 3](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe/specification/marlowe-isabelle-specification-4f9fa249fa51ec09a4f286099d5399eb4301ed49.pdf)
- [Marlowe-Cardano Specification](https://github.com/marlowe-lang/marlowe-cardano/tree/main/marlowe/specification)

### Testing and debugging

- [The Marlowe Debugging Cookbook](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe/debugging-cookbook.md)
- [Marlowe Test Report](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe/test/test-report.md)

### Tools

- [Marlowe CLI](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe-cli/ReadMe.md): a command-line interface for running Marlowe contracts on the Cardano blockchain.
- [Marlowe Runtime](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe-runtime/doc/ReadMe.md): an application back-end for running Marlowe contracts on the Cardano blockchain.
- [Marlowe Lambda](https://github.com/marlowe-lang/marlowe-lambda): an AWS Lambda client for Marlowe Runtime.

### Examples

- [Gallery of Marlowe Contracts on Cardano Mainnet (Real World Marlowe)](https://github.com/marlowe-lang/real-world-marlowe)
- [Index of example Marlowe contracts and their on-chain execution](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe/example-contracts.md)
- [Marlowe Debugging Cookbook](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe/debugging-cookbook.md)
- [Marlowe Runtime Tutorial](https://github.com/marlowe-lang/marlowe-cardano/blob/main/marlowe-runtime/doc/tutorial.md)
- [Marlowe Runtime examples](https://www.youtube.com/playlist?list=PLnPTB0CuBOByd1Y6W9B8Xj_wiiWkobtrY)
- [Haskell examples of Marlowe contracts](https://github.com/marlowe-lang/marlowe-cardano/tree/main/marlowe-contracts)
- [ACTUS contracts in Marlowe](https://github.com/marlowe-lang/marlowe-cardano/tree/main/marlowe-actus)
...
- [Response to Audit Report for the Marlowe Specification (IOG)](https://github.com/marlowe-lang/marlowe/blob/master/response-to-audit-report.md)
