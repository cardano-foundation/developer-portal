...
sidebar_label: "15 - Cardano Governance"
...
The natural next step is to put this knowledge into practice. Head over to the [Hello Cardano](../practical-overview.md) coding course, where you will start building on Cardano: setting up a development environment, constructing transactions, interacting with smart contracts, and deploying your first on-chain applications. The theory you have learned here will serve as your compass as you navigate the practical challenges of blockchain development.
