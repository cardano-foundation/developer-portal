...
> Source code: [GitHub](https://github.com/cardano-foundation/developer-portal/tree/staging/examples/bootcamp/07-vesting)
...
See the full test source in [`vesting.ak`](https://github.com/cardano-foundation/developer-portal/blob/staging/examples/bootcamp/07-vesting/src/aiken-workspace/validators/vesting.ak).
...
This command will generate a CIP-0057 Plutus blueprint, which you can find in [`plutus.json`](https://github.com/cardano-foundation/developer-portal/blob/staging/examples/bootcamp/07-vesting/src/aiken-workspace/plutus.json).
...
The source code for this lesson is available on [GitHub](https://github.com/cardano-foundation/developer-portal/tree/staging/examples/bootcamp/07-vesting).
