...
Decide how your dApp will read and submit to the chain: a managed API (fastest to ship) or your own node and indexer (most control). See [Production infrastructure](/docs/build/scaling/infrastructure) for the full decision.
