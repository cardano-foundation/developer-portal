...
A high-precision digital **temperature and humidity sensor** from Aosong with an I2C interface. Used in [Workshop 03 - Connect and Read Sensor Data](/docs/build/iot-on-cardano/input-and-write/01-connect-and-read-sensor-data) to read environmental data and post it on-chain as transaction metadata or NFTs.
