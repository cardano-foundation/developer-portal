...
- **WiFi power workaround.** The Super Mini variant often needs `WiFi.setTxPower(WIFI_POWER_8_5dBm);` to connect reliably. See [Troubleshooting](/docs/build/iot-on-cardano/troubleshooting) for the full note.
