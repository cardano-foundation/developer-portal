...
- `GET https://preprod.koios.rest/api/v1/tip` - chain tip endpoint, used in [Workshop 01: API Setup](/docs/build/iot-on-cardano/the-basics/03-api-setup).
- `POST /account_info` - wallet balance lookup, used in [Workshop 02: Fetch Wallet Balance](/docs/build/iot-on-cardano/read-and-output/01-fetch-wallet-balance).
- `POST /address_utxos` - UTxO listing, used in [Workshop 05: Building the Backend](/docs/build/iot-on-cardano/qr-code-payments/05-building-the-backend).
