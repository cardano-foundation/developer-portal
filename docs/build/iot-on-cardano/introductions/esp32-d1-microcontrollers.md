---
id: esp32-d1-microcontrollers
title: ESP32 / D1 Microcontrollers
sidebar_label: ESP32 / D1 Microcontrollers
description: Low-cost, low-power Wi-Fi and Bluetooth microcontrollers from Espressif - the boards used across this section.
---
...
The workshops in this section default to the **ESP32-C3** - see the [ESP32-C3 hardware page](/docs/build/iot-on-cardano/hardware/esp32-c3) for the specific variant used and known quirks.

## Resources

- [Espressif official site](https://www.espressif.com/)
...
*Adapted from the [CardanoThings](https://cardanothings.io/introductions/esp32-d1-microcontrollers) project, originally produced under [Project Catalyst Fund 11](https://projectcatalyst.io/funds/11). Source: [github.com/CardanoThings](https://github.com/CardanoThings).*
