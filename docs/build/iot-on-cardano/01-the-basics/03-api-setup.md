...
We use the [HTTP Client](https://www.arduino.cc/reference/en/libraries/https-client/) library to make the request and the [ArduinoJSON](https://www.arduino.cc/reference/en/libraries/arduinojson/) library to parse the response.
