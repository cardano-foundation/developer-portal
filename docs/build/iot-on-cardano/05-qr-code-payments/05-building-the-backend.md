...
Create a second Cardano wallet so you can pay from one and listen on the other. You already know how to create a wallet from [Workshop 01](/docs/build/iot-on-cardano/the-basics/01-cardano-setup).
