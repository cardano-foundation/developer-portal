...
The `data/` directory must be re-uploaded to LittleFS every time you change the frontend. See [Getting Started](/docs/build/iot-on-cardano/qr-code-payments/01-getting-started#uploading-files-to-littlefs) for the procedure.
:::
