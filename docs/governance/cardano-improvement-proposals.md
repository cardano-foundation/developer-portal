...
alt="CIP workflow"
sources={{
    light: useBaseUrl('/img/governance/cips/cip_workflow_light.png'),
    dark: useBaseUrl('/img/governance/cips/cip_workflow_dark.png'),
  }}
/>
...
The format of the Author(s) header value must be:
  ...
  Random J. User <address@example.invalid>
