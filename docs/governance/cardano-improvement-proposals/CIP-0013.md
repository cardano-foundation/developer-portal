--- 
sidebar_label: (13) Cardano URI Scheme
title: Cardano URI Scheme

CIP: 13
Title: Cardano URI Scheme
Authors: Sebastien Guillemot , Vicente Almonacid , Robert Phair 
Comments-URI:
...
Donate
Stake with us
Split between our 2 related pools
Choose our least saturated pool
```
...
## CIP Information  
This [Informational](CIP-0001#cip-format-and-structure) CIP-0013 created on **2020-09-22** has the status: [Draft](CIP-0001#cip-workflow).  
This page was generated automatically from: [cardano-foundation/CIPs](https://github.com/cardano-foundation/CIPs/tree/master/CIP-0013/README.md).