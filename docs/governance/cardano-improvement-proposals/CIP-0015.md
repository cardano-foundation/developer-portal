--- 
sidebar_label: (15) Catalyst Registration Transaction Metadata Format
...
See the [schema file](https://raw.githubusercontent.com/cardano-foundation/CIPs/master/CIP-0015/schema.cddl)

### Test vector

See [test vector file](https://raw.githubusercontent.com/cardano-foundation/CIPs/master/CIP-0015/test-vector.md)
...
## CIP Information  
This [Standards](CIP-0001#cip-format-and-structure) CIP-0015 created on **2020-01-05** has the status: [Draft](CIP-0001#cip-workflow).  
This page was generated automatically from: [cardano-foundation/CIPs](https://github.com/cardano-foundation/CIPs/tree/master/CIP-0015/README.md).