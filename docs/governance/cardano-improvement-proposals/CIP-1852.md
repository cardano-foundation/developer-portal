--- 
sidebar_label: (1852) HD (Hierarchy for Deterministic) Wallets for Cardano
title: HD (Hierarchy for Deterministic) Wallets for Cardano

CIP: 1852
Title: HD (Hierarchy for Deterministic) Wallets for Cardano
Authors: Sebastien Guillemot , Matthias Benkort 
...
## CIP Information  
This [Standards](CIP-0001#cip-format-and-structure) CIP-1852 created on **2019-10-28** has the status: [Draft](CIP-0001#cip-workflow).  
This page was generated automatically from: [cardano-foundation/CIPs](https://github.com/cardano-foundation/CIPs/tree/master/CIP-1852/README.md).