--- 
sidebar_label: (30) Cardano dApp-Wallet Web Bridge
...
then we define
```
type TransactionUnspentOutput = cbor
```
...
### api.signData(addr: cbor, sigStructure: cbor): Promise
...
## CIP Information  
This [Standards](CIP-0001#cip-format-and-structure) CIP-0030 created on **2021-04-29** has the status: [Draft](CIP-0001#cip-workflow).  
This page was generated automatically from: [cardano-foundation/CIPs](https://github.com/cardano-foundation/CIPs/tree/master/CIP-0030/README.md).