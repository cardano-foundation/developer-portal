--- 
sidebar_label: (1855) Forging policy keys for HD Wallets
title: Forging policy keys for HD Wallets

CIP: 1855
Title: Forging policy keys for HD Wallets
Authors: Samuel Leathers , John Lotoski , Michael Bishop , David Arnold 
...
## CIP Information  
This [Standards](CIP-0001#cip-format-and-structure) CIP-1855 created on **2021-06-02** has the status: [Draft](CIP-0001#cip-workflow).  
This page was generated automatically from: [cardano-foundation/CIPs](https://github.com/cardano-foundation/CIPs/tree/master/CIP-1855/README.md).