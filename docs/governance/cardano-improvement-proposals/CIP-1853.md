--- 
sidebar_label: (1853) HD (Hierarchy for Deterministic) Stake Pool Cold Keys for Cardano
title: HD (Hierarchy for Deterministic) Stake Pool Cold Keys for Cardano

CIP: 1853
Title: HD (Hierarchy for Deterministic) Stake Pool Cold Keys for Cardano
Authors: Rafael Korbas 
...
## CIP Information  
This [Standards](CIP-0001#cip-format-and-structure) CIP-1853 created on **2020-12-14** has the status: [Draft](CIP-0001#cip-workflow).  
This page was generated automatically from: [cardano-foundation/CIPs](https://github.com/cardano-foundation/CIPs/tree/master/CIP-1853/README.md).