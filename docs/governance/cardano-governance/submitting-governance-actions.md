...
3. **Choose a Submission Method:** You can submit governance actions using:
    - **cardano-cli:** The command-line interface for interacting with the Cardano blockchain. [How to propose a governance actions Via Cardano-cli](/docs/learn/cardano-cli/governance/create-governance-actions)
...
- [**Governance Action cardano-cli Submission Guide**](/docs/learn/cardano-cli/governance/create-governance-actions)
