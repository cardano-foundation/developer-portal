...
To produce a delegation certificate, your stake address must already be registered on the chain, as outlined in the documentation on [registering the stake address](./stakeaddress-registration). Additionally, you need to know the pool ID to which you will delegate.
