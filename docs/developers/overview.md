...
When you're ready to build something specific, the **Integrations** guides cover [Payments](/docs/developers/integrations/payments/listening-for-payments/overview), [AI Agents](/docs/developers/curriculum/dapps/ai-agents/overview), and [Internet of Things](/docs/developers/integrations/iot/), and there's a dedicated [Exchange Integrations](/docs/developers/integrations/exchange-integrations) track for custodial platforms.
