...
For the broader introduction to what Cardano is and why you would build here (the origin story, the research foundation, what you can ship), see the [Get Started overview](/docs/developers/). This module is the technical grounding underneath it.
