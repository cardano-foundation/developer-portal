...
To explore more real-world smart contracts written in Aiken, see the [Example Contracts](/docs/developers/curriculum/smart-contracts/example-contracts).
...
For a deeper dive into how smart contracts work on Cardano, see the [Smart Contracts overview](/docs/developers/curriculum/smart-contracts/overview). Below are common patterns you'll encounter when building validators.
...
Client SDKs handle transaction building, wallet integration, UTxO selection, and fee calculation. They're equivalent to ethers.js or web3.js but for Cardano. See the full [Client SDKs documentation](/docs/developers/curriculum/start-building/choose-your-tools) for detailed guides.
