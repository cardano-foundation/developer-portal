...
- [Example contracts](/docs/developers/curriculum/smart-contracts/example-contracts): escrow, marketplace, swap, and more
- Reference: [example contracts](/docs/developers/curriculum/smart-contracts/example-contracts) and the [Mesh smart contracts guide](https://meshjs.dev/apis/txbuilder/smart-contract)
