...
[Cardano Dev Skills](https://github.com/easy1staking-com/cardano-dev-skills) is the go-to plugin for this today. It bundles authoritative Cardano documentation and behavioral "skills" for AI coding agents, refreshed weekly from upstream project repositories, so your assistant answers from current sources rather than guessing from training data.
...
Then run `/cardano-context` once per project to wire the directive into your `CLAUDE.md`. For other agents, clone the repo and symlink the skills into your project's `.agents/skills` directory. See the [repository](https://github.com/easy1staking-com/cardano-dev-skills) for the full list of skills and setup details.
