...
:::note
This guide assumes that you have basic understanding of `cardano-cli`, how to use it and that you have installed it into your system. Otherwise we recommend reading [Installing cardano-node](/docs/developers/curriculum/production/node/installing-cardano-node), [Running cardano-node](/docs/developers/curriculum/production/node/running-cardano) and [Get started with Cardano CLI](/docs/developers/curriculum/start-building/your-first-transaction) guides first.

This guide also assumes that you have `cardano-node` running in the background and connected to a [testnet network](/docs/developers/curriculum/start-building/networks-and-test-ada).
:::
