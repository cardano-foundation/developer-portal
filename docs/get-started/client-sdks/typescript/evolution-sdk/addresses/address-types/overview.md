...
|--------------|---------|---------|---------------|---------------|-------------|
| **[Base](./base)** | Yes | Yes | 57 bytes | `addr`/`addr_test` | `0000`–`0011` |
| **[Enterprise](./enterprise)** | Yes | No | 29 bytes | `addr`/`addr_test` | `0110`–`0111` |
| **[Reward](./reward)** | No | Yes | 29 bytes | `stake`/`stake_test` | `1110`–`1111` |
| **[Pointer](./pointer)** | Yes | Pointer | Variable | `addr`/`addr_test` | `0100`–`0101` |
...
- **[Conversion](../conversion)** - Format transformations (Bech32, hex, bytes)
- **[Validation](../validation)** - Parsing and validation
