...
Now we can finally request some `tAda` for the wallet address from the [Cardano Testnet Faucet](/docs/get-started/networks/testnets).

Once you requested some `tAda` from the [Cardano Testnet Faucet](/docs/get-started/networks/testnets), we can then check if it has arrived into our wallet like so:
...
As we can see here we have a total of `1,000,000,000 lovelace` available to spend that we received from the [Cardano Testnet Faucet](/docs/get-started/networks/testnets).
