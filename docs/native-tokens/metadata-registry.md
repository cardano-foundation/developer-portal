...
CIP-20 transaction messages are covered under [Transactions](/docs/value/transactions); this page focuses on token metadata.
...
- [Mint an NFT](/docs/native-tokens/mint-nft): attach CIP-25 metadata while minting
- [What are native tokens](/docs/native-tokens/overview): fungibility, policy IDs, min-ADA
