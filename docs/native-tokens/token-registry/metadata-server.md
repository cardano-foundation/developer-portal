...
- [Register an entry](/docs/native-tokens/token-registry/register-an-entry): publish the CIP-26 metadata this server returns
- [Token metadata & registry](/docs/native-tokens/metadata-registry): how CIP-25, CIP-26, CIP-27, and CIP-68 fit together
