...
This page assumes you have completed [Generating Wallet Keys](/docs/operators/block-producer/generating-wallet-keys) and that `CARDANO_NODE_SOCKET_PATH` and `CARDANO_NODE_NETWORK_ID` are set.
...
Next: [Register your pool](/docs/operators/block-producer/register-stake-pool).
