...
![multiple Layers benefiting from openBlockPerf telemetry data](./img/openBlockperf_layer-benefits.png)
...
![block propagation perception from multiple nodes in a gantt diagramm](./img/openBlockperf_block-propagation-gantt-diagram.png)
