...
:::note
This guide assumes you have installed `cardano-wallet` into your system. If not you can refer to [Installing cardano-wallet](../get-started/cardano-wallet/installing-cardano-wallet.mdx) guide for instructions on how to do that.
