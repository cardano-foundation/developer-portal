...
This guide is a walkthrough on how to implement the *message signing* described in [CIP-08](../../docs/governance/cardano-improvement-proposals/CIP-0008.md) in order to authenticate users on the web with just their [CIP-30](../../docs/governance/cardano-improvement-proposals/CIP-0030.md)-compatible wallet app.
