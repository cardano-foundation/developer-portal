...
const redirects = [
  ...
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost', from: '/docs/get-started/infrastructure/api-providers/blockfrost/cardano-apis' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost', from: '/docs/get-started/infrastructure/api-providers/blockfrost/get-started' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost', from: '/docs/get-started/infrastructure/api-providers/blockfrost/open-source' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost', from: '/docs/get-started/infrastructure/api-providers/blockfrost/other-apis' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost', from: '/docs/get-started/infrastructure/api-providers/blockfrost/overview' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost', from: '/docs/get-started/infrastructure/api-providers/blockfrost/secure-webhooks' },
