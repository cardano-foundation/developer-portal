...
const redirects = [
  ...
  { to: '/docs/learn/cardano-cli/basic-operations/stakeaddress-registration', from: '/docs/get-started/infrastructure/cardano-cli/basic-operations/stakeaddress-registration' },
  { to: '/docs/learn/cardano-cli/basic-operations/stake-address-delegation', from: '/docs/get-started/infrastructure/cardano-cli/basic-operations/stake-address-delegation' },
  ...
  { to: '/docs/learn/cardano-cli/basic-operations/treasury-donations', from: '/docs/get-started/infrastructure/cardano-cli/basic-operations/treasury-donations' },
  ...
  { to: '/docs/learn/cardano-cli/governance/voting', from: '/docs/get-started/infrastructure/cardano-cli/governance/voting' },
  { to: '/docs/learn/cardano-cli/governance/gov-queries', from: '/docs/get-started/infrastructure/cardano-cli/governance/gov-queries' },
  { to: '/docs/learn/cardano-cli/governance/governance-actions', from: '/docs/get-started/infrastructure/cardano-cli/governance/governance-actions' },
  ...
  { to: '/docs/learn/cardano-cli/governance/delegating-vote', from: '/docs/get-started/infrastructure/cardano-cli/governance/delegating-vote' },
  ...
  { to: '/docs/learn/cardano-cli/native-assets/native-assets', from: '/docs/get-started/infrastructure/cardano-cli/native-assets/native-assets' },
  { to: '/docs/learn/cardano-cli/simple-scripts/simple-scripts', from: '/docs/get-started/infrastructure/cardano-cli/simple-scripts/simple-scripts' },
  { to: '/docs/learn/cardano-cli/plutus-scripts/plutus-scripts', from: '/docs/get-started/infrastructure/cardano-cli/plutus-scripts/plutus-scripts' },
];
