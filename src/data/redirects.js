...
const redirects = [
  ...
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost/cardano-api', from: '/docs/get-started/infrastructure/api-providers/blockfrost/cardano-apis' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost/get-started', from: '/docs/get-started/infrastructure/api-providers/blockfrost/get-started' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost/open-source', from: '/docs/get-started/infrastructure/api-providers/blockfrost/open-source' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost/others-api', from: '/docs/get-started/infrastructure/api-providers/blockfrost/other-apis' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost/overview', from: '/docs/get-started/infrastructure/api-providers/blockfrost/overview' },
  { to: '/docs/developers/curriculum/production/api-providers/blockfrost/secure-webhooks', from: '/docs/get-started/infrastructure/api-providers/blockfrost/secure-webhooks' },
  { to: '/docs/developers/curriculum/production/api-providers/koios', from: '/docs/get-started/infrastructure/api-providers/koios' },
