  ...
  return [
    {
      ...
      position: 'left',
      items: [
        {to: "/docs/get-started/", label: "Start Here"},
        ...
        columns: [
          {
            ...
            icon: 'book-solid',
            items: [
              {to: '/docs/get-started/', label: 'Start Here', description: 'The 7-module developer curriculum, zero to shipping', icon: 'book-solid'},
