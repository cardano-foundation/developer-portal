  ...
  return [
    {
      ...
      items: [
        ...
        {to: "/templates/contracts/", label: "Contract Library"},
        ...
        columns: [
          {
            ...
            items: [
              ...
              {to: '/templates/contracts', label: 'Contract Library', description: 'Smart-contract patterns with on-chain and off-chain implementations', icon: 'scroll-solid'},
