...
const Showcases = [
  ...
  },
  {
    title: "CardaStat",
    description:
      "Historical rewards data for accurate comparison of pool performances. Delegators are able to see actual potential rewards once fees are taken into account.",
