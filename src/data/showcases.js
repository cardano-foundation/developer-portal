...
export const Tags = {
    ...
    favorite: {
        label: 'Favorite',
        description: 'Our favorite Cardano projects that you must absolutely check-out.',
...
export const Showcases = [
    ...
    {
        title: 'Cardano Kidz',
        description: 'Each of these unique Limited Edition designs is being minted on the Cardano Blockchain as a Non Fungible Token (NFT).',
    ...
    {
        title: 'Cardano Wall',
        description: 'Demonstrates several use cases for transaction metadata. You can sign messages and create proof of existence for files.',
    ...
    {
        title: 'NMKR',
        description: 'NFT Minting, FIAT & Crypto Sales, Token Launches, Secondary Markets - all available at the press of a button.',
    ...
    {
        title: 'AdaStat',
        description: 'The browser, inconspicuous at first glance, offers a great many statistics and insights.',
    ...
    },
    {
        ...
        description: 'List of Cardano Explorers built by the community for the community.',
    ...
    {
        title: 'CExplorer',
        description: 'An independent Cardano Explorer that provides useful all-in-one dashboards additionally.',
    ...
    {
        title: 'Cardano Scan',
        description: "A combination of block explorer and pool tool, uses it's own implementation of db-sync.",
    ...
    {
        title: 'Pool PM',
        description: 'Block explorer that brought out a new, refreshing concept to visualize transactions.',
    ...
    {
        title: 'Atomic Wallet',
        description: 'Multi-cryptocurrency wallet that supports Cardano. During the integration they contributed code to the Cardano Rust library.',
    ...
    {
        title: 'Daedalus',
        description: 'Daedalus is a full node and developed by IOHK, one of the founding entities of Cardano.',
    ...
    {
        title: 'Yoroi',
        description: 'Yoroi is a lightweight node and developed by EMURGO, one of the founding entities of Cardano.',
    ...
    },
    {
        ...
        description: 'Follow the development of Cardano in real time without the hassle of GitHub.',
    ...
    },
    {
        ...
        description: 'A Google Data Studio dashboard that visualizes many Cardano on-chain metrics.',
    ...
    },
    {
        ...
        description: 'Explore Cardano, track your rewards and get notified to take action on certain events.',
    ...
    {
        title: 'NOWPayments',
        description: 'Payment gateway provider to accept ada payments and ada donations.',
    ...
    {
        title: 'Eternl',
        description: 'The alternative Cardano light wallet in the browser. Aims to add features most requested by the Cardano community.',
    ...
    },
    {
        ...
        description: 'Create your own native tokens and NFT in a few clicks without any code.',
    ...
    {
        title: 'Veritree',
        description: 'Veritree leverages blockchain technology to provide planting organizations with an integrated planting management platform.',
    ...
    {
        title: 'ADAdice',
        description: 'A fully on-chain, provably fair game of dice on the Cardano blockchain.',
    ...
    {
        title: 'MuesliSwap',
        description: 'MuesliSwap is a new decentralized exchange (DEX) operating on the Smart Bitcoin Cash blockchain and Cardano.',
    ...
    {
        title: 'SundaeSwap',
        description: 'SundaeSwap is a native, scalable decentralized exchange and automated liquidity provision protocol.',
    ...
    },
    {
        ...
        description: 'Connecting everyone, everywhere. A mobile network owned by the people and built on blockchain.',
    ...
    },
    {
        ...
        description: 'The ultimate wallet experience for the Web, with native NFT and token features, powered by Cardano and third party applications.',
    ...
    {
        title: 'CardanoCube',
        description: 'Explore 650+ Projects Building on Cardano.',
    ...
    {
        title: 'JPG Store',
        description: 'Discover artwork, explore communities, and support artists on Cardano.',
    ...
    {
        title: 'Pavia',
        description: 'Create, explore and trade in the Cardano virtual world owned by its users.',
    ...
    {
        title: 'Lido Nation',
        description: 'Aggregation of existing catalyst proposals, results, feedbacks and many more.',
    ...
    {
        title: 'Book.io',
        description: 'An NFT marketplace for buying, reading, and selling eBooks and Audiobooks.',
    ...
    {
        title: 'NuFi Wallet',
        description: 'Non-custodial, multi-chain wallet with in-app DEX.',
    ...
    {
        title: 'Carda Station',
        description: 'Explore this virtual world on the moon with an in game avatar, and interact with other players through hangouts, games or events.',
    ...
    {
        title: 'CNFTLab Party',
        description: 'Tool for minting CNFTs, manage your policyID, create royalties and start minting in few seconds.',
    ...
    {
        title: 'TapTools',
        description: 'All-in-one platform that offers free token distribution, comprehensive charts, NFT generation, and mint facilitation.',
    ...
    {
        title: 'Chainport',
        description: 'ChainPort is a next-gen hard-security blockchain bridge that lets you hop across EVM chains to Cardano at a click.',
    ...
    },
    {
        ...
        description: 'Create and mint NFTs on Cardano all in your browser - without trusting a third party for minting.',
    ...
    },
    {
        ...
        description: 'Shows geographical distribution of Cardano stake pool relay nodes with flexible map features.',
    ...
    },
    {
        ...
        description: 'Move supported tokens cross-chain, from BSC to Cardano and vice versa.',
    ...
    },
    {
        ...
        description: 'Graphical, configurable analytics specialising in Cardano PoS decentralisation metrics.',
    ...
    {
        title: 'Aeoniumsky',
        description: 'Winner of the CNFT Awards 2022 in the category "best digital art".',
    ...
    {
        title: 'Universe 25',
        description: 'Winner of the CNFT Awards 2022 in the category "Zeitgeist".',
    ...
    },
    {
        ...
        description: 'Winner of the CNFT Awards 2022 in the category "most innovative".',
    ...
    {
        title: 'Hosky',
        description: 'Meme coin. Winner of the CNFT Awards 2022 in the category "most impactful".',
    ...
    {
        title: 'adahandle',
        description: 'A standardized NFT that developers and users can use to associate an address with a custom and human-readable address.',
    ...
    {
        title: 'Aada.finance',
        description: 'Aada is a peer-to-peer lending and borrowing protocol on the Cardano blockchain.',
    ...
    },
    {
        ...
        description: '$COTO provides secure, global and long-lasting cold storage backups of Cardano NFT media.',
    ...
    },
    {
        ...
        description: 'A DAO creation and governance platform on the Cardano blockchain.',
    ...
    {
        title: 'DexHunter',
        description: 'DexHunter is a decentralized exchange aggregator with real-time alerts and an easy to use interface.',
    ...
    {
        title: 'Liqwid',
        description: 'Liqwid is a non-custodial pooled lending protocol with liquid staking built on Cardano.',
    ...
    {
        title: 'Chang Watch',
        description: 'Chang Watch provides various donut charts with insights on vote distribution and DReps.',
    ...
    },
    {
        ...
        description: 'Secure your treasury and participant in governance, as a team with multi-signature.',
    ...
    {
        title: 'Nio',
        description: 'Track and monitor all assets in any wallet or locked in Cardano DeFi smart contracts.',
    ...
    {
        title: 'Onboard Ninja',
        description: 'Onboard is a platform that allows creators to effortlessly distribute Cardano airdrops at in-person events.',
    ...
    },
    {
        ...
        description: 'This is a budget proposal aggregator tool, designed to help DReps and ada holders easily track submitted proposals.',
    ...
    },
    {
        ...
        description: 'A simple tool to help every Cardano stakeholder participate in on-chain governance with confidence.',
    ...
    {
        title: 'Genius Yield',
        description: 'All-in-one platform, that combines an order book DEX with an automated yield optimizer.',
    ...
    {
        title: 'Iagon',
        description: 'Iagon is an AI-driven shared storage and compute economy. Bridging decentralization with compliance to revolutionize cloud services.',
    ...
    {
        title: 'Splash',
        description: 'Decentralized open-source protocol for efficient market-making and trading on Cardano.',
    ...
    {
        title: 'Palmyra',
        description: 'Empowering inclusion for underserved commodities through RWA Tokenization.',
    ...
    {
        title: 'Optim Finance',
        description: 'Optimize your yield with a decentralized suite of products.',
    ...
    {
        title: 'Farmroll',
        description: 'Crypto engagement platform designed to enhance community interaction, incentivized participation, and AI-driven automation',
    ...
    {
        title: 'Empowa',
        description: 'Join a RWA project looking to enable 1 million African families to become owners of a climate-smart home across Africa by 2030.',
    ...
    },
    {
        ...
        description: 'DeFi derivatives protocol revolutionizing perpetual futures trading on the Cardano blockchain.',
    ...
    {
        title: 'Finest',
        description: 'Invest in tokenized real world assets. Fully regulated and compliant in Europe.',
    ...
    {
        title: 'Butane',
        description: 'Butane is a fast, powerful, and innovative decentralised synthetics platform built on the Cardano blockchain.',
    ...
    {
        title: 'Cornucopias',
        description: "Open world MMO set in a world where humanity has ascended from the Earth's surface and created a breathtaking new world in the sky. ",
    ...
    {
        title: 'Asteria',
        description: 'A fully on-chain strategy game for devs. Pilot a spaceship in a 2D grid where everything is a UTxO. ',
...
function ensureShowcaseValid(showcase) {
    function checkFields() {
        ...
        const validKeys = ['title', 'description', 'preview', 'website', 'source', 'tags'];
    ...
    function checkWebsite() {
        ...
        const isHttpUrl = showcase.website.startsWith('http://') || showcase.website.startsWith('https://');
        if (!isHttpUrl) {
            throw new Error(`Site website does not look like a valid url: ${showcase.website}`);
        }
    }

    function checkPreview() {
        if (!showcase.preview || (showcase.preview instanceof String && (showcase.preview.startsWith('http') || showcase.preview.startsWith('//')))) {
            throw new Error(
    ...
    try {
        ...
        throw new Error(`Showcase site with title=${showcase.title} contains errors:\n${e.message}`);
    }
}
